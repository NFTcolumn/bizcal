...
function App() {
  const [fixedCosts, setFixedCosts] = useState<CostItem[]>([
    ...
    { id: uuidv4(), name: 'Subscribtions', amount: 200 }
  ]);
  ...
  const metrics = useMemo(() => {
    return calculateMetrics(fixedCosts, variableCosts, goalProfit, expectedUnits);
  }, [fixedCosts, variableCosts, goalProfit, expectedUnits]);
    ...
    <div className="container">
      ...
      <section className="grid" style={{ marginBottom: '2rem' }}>
        ...
        <MetricCard
          ...
          value={metrics.totalUnitCost.toFixed(2)}
          prefix="$"
        />
        <MetricCard
